...
/**
 * 模板版本项目快照。版本发布后项目不可修改；
 * 巡检任务按冻结的版本判定，巡检记录通过 template_version_item_id 追溯定义。
 */
@Entity
@Table(name = "inspection_template_version_items")
public class InspectionTemplateVersionItem {
